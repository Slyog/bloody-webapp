...
export const heroHome: HeroProps = {
  title: (
    <>
      Launch <span>BloodyARK</span> seasons faster with <span>Next.js</span> +{' '}
  ...
  subtitle: (
    <>
      <span className="hidden md:inline">
        ...
        gives you a production-ready marketing site tuned for ARK: Survival Ascended communities with{' '}
        <em>Next.js</em> + <em>Tailwind CSS</em>.
      </span>{' '}
      Drop in hero, feature, and community modules, all optimized for SEO, accessibility, and lightning-fast load times.
    </>
  ),
  callToAction: {
    text: 'Join Discord',
...
export const featuresHome: FeaturesProps = {
  ...
  header: {
    title: (
      <>
        What you get with <span className="whitespace-nowrap">BloodyARK</span>
      </>
    ),
    subtitle:
  ...
  testimonials: [
    {
      ...
      testimonial: `I'm impressed by the speed and performance of these presets. Our landing now loads in the blink of an eye, significantly enhancing our visitors' experience. Thanks to BloodyARK, our player signups are thriving.`,
      image: {
    ...
    },
    {
      name: 'Silver Jordan',
      job: 'Senior Marketer',
      testimonial: `I had never found it so easy to customize a launch page. BloodyARK's sections are incredibly flexible, and with Tailwind CSS, I've dialed in the exact look we wanted. Highly recommended!`,
      image: {
    ...
    },
    {
      name: 'Lisa Gordon',
      job: 'Project Manager',
      testimonial: `Their presets are not only stunning but also user-friendly. The support I received from the BloodyARK community has been exceptional. I'm proud to say that I've built my dream ARK hub with BloodyARK.`,
      image: {
