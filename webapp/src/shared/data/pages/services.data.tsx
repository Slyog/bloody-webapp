  ...
  testimonials: [
    {
      name: 'Silver Jordan',
      job: 'Senior Marketer',
      testimonial: `I had never found it so easy to customize a website. BloodyARK's presets are incredibly flexible, and with Tailwind CSS, I've managed to give my launch the look and feel I always wanted. Highly recommended!`,
      image: {
    ...
    },
    {
      name: 'Lisa Gordon',
      job: 'Project Manager',
      testimonial: `Their presets are not only stunning but also user-friendly. The support I received from the BloodyARK community has been exceptional. I'm proud to say that I've built my dream website with BloodyARK.`,
      image: {
